...
<header style="background-image:url(headernew.jpg)">
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="font-color:black">Time Table Generator</h1>
                <hr>
...
<?php echo @$err; ?>
 ...
 <div class="row" style="margin-bottom: 10px;">
    ...
    <div class="container p-4">
        ...
        <div class="row">
            <div class="col">
                <a href="https://www.linkedin.com/"><i class="fab fa-linkedin fa-2x text-white mx-3"></i></a>
                <a href="https://www.instagram.com/"><i class="fab fa-instagram fa-2x text-white mx-3"></i></a>
                <a href="https://www.facebook.com/"><i class="fab fa-facebook fa-2x text-white mx-3"></i></a>
                <a href="mailto:your_email@example.com"><i class="far fa-envelope fa-2x text-white mx-3"></i></a>
            </div>
        </div>
    </div>
</footer>

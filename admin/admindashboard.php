    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
              ...
              <p> <span style="color:#FFF; margin:20px; padding:20px;" >Hello Admin</span>
<span style="margin-left:1200px" class="glyphicon-glyphicon-off" aria-hidden="true">
<a href="logout.php"><font color="#FFFFFF" class="btn btn-success" style="float: right;">Logout</font></a></span>
</p>
            </div>
